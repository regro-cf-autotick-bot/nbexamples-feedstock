About nbexamples-feedstock
==========================

Feedstock license: [BSD-3-Clause](https://github.com/conda-forge/nbexamples-feedstock/blob/main/LICENSE.txt)
...
<table><tr><td>All platforms:</td>
    <td>
      <a href="https://dev.azure.com/conda-forge/feedstock-builds/_build/latest?definitionId=5628&branchName=main">
        <img src="https://dev.azure.com/conda-forge/feedstock-builds/_apis/build/status/nbexamples-feedstock?branchName=main">
      </a>
    </td>
  </tr>
</table>
...
Once the `conda-forge` channel has been enabled, `nbexamples` can be installed with `conda`:
...
```
mamba install nbexamples
```

It is possible to list all of the versions of `nbexamples` available on your platform with `conda`:
...
```
mamba search nbexamples --channel conda-forge
```
...
mamba repoquery search nbexamples --channel conda-forge

# List packages depending on `nbexamples`:
mamba repoquery whoneeds nbexamples --channel conda-forge

# List dependencies of `nbexamples`:
mamba repoquery depends nbexamples --channel conda-forge
```
